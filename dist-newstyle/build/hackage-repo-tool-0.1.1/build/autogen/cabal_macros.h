...
/* package hackage-repo-tool-0.1.1 */
#define VERSION_hackage_repo_tool "0.1.1"
#define MIN_VERSION_hackage_repo_tool(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hackage-repo-tool-0.1.1"

#define CURRENT_PACKAGE_KEY "hackage-repo-tool-0.1.1"
